...
public partial class ImpossibleGame : ContentPage
{
    ...
    {
        public const int INITIAL_TIME = 90;
    ...
    private readonly int[] _columnArray8 = new int[Constants.NUM_ROWS];
    ...
    public async void CreateNewPattern()
    {
        ...
        // Generate 8 random numbers between 1 and 7 that will each represent one index of each column.
        Random rand = new Random();
        for (int i = 0; i < Constants.NUM_COLUMNS; i++)
            _correctIndexes[i] = rand.Next(1, 8);
        ...
        _columnArray8[_correctIndexes[7] - 1] = 1;
    ...
    public void ErasePattern()
    {
        ...
        btn7x7.BackgroundColor = Color.Parse("Transparent");
        btn1x8.BackgroundColor = Color.Parse("Transparent");
        btn2x8.BackgroundColor = Color.Parse("Transparent");
        btn3x8.BackgroundColor = Color.Parse("Transparent");
        btn4x8.BackgroundColor = Color.Parse("Transparent");
        btn5x8.BackgroundColor = Color.Parse("Transparent");
        btn6x8.BackgroundColor = Color.Parse("Transparent");
        btn7x8.BackgroundColor = Color.Parse("Transparent");
    }
    public void IncorrectRed()
    {
        ...
        btn7x1.BackgroundColor = Color.Parse("Red"); btn7x1.BorderColor = Color.Parse("Red");
        ...
        btn7x2.BackgroundColor = Color.Parse("Red"); btn7x2.BorderColor = Color.Parse("Red");
        ...
        btn7x3.BackgroundColor = Color.Parse("Red"); btn7x3.BorderColor = Color.Parse("Red");
        ...
        btn7x4.BackgroundColor = Color.Parse("Red"); btn7x4.BorderColor = Color.Parse("Red");
        ...
        btn7x5.BackgroundColor = Color.Parse("Red"); btn7x5.BorderColor = Color.Parse("Red");
        ...
        btn7x6.BackgroundColor = Color.Parse("Red"); btn7x6.BorderColor = Color.Parse("Red");
        ...
        btn7x7.BackgroundColor = Color.Parse("Red"); btn7x7.BorderColor = Color.Parse("Red");
        btn1x8.BackgroundColor = Color.Parse("Red"); btn1x8.BorderColor = Color.Parse("Red");
        btn2x8.BackgroundColor = Color.Parse("Red"); btn2x8.BorderColor = Color.Parse("Red");
        btn3x8.BackgroundColor = Color.Parse("Red"); btn3x8.BorderColor = Color.Parse("Red");
        btn4x8.BackgroundColor = Color.Parse("Red"); btn4x8.BorderColor = Color.Parse("Red");
        btn5x8.BackgroundColor = Color.Parse("Red"); btn5x8.BorderColor = Color.Parse("Red");
        btn6x8.BackgroundColor = Color.Parse("Red"); btn6x8.BorderColor = Color.Parse("Red");
        btn7x8.BackgroundColor = Color.Parse("Red"); btn7x8.BorderColor = Color.Parse("Red");
    }
    public void CorrectGreen()
    {
        ...
        btn7x1.BackgroundColor = Color.Parse("Green"); btn7x1.BorderColor = Color.Parse("Green");
        ...
        btn7x2.BackgroundColor = Color.Parse("Green"); btn7x2.BorderColor = Color.Parse("Green");
        ...
        btn7x3.BackgroundColor = Color.Parse("Green"); btn7x3.BorderColor = Color.Parse("Green");
        ...
        btn7x4.BackgroundColor = Color.Parse("Green"); btn7x4.BorderColor = Color.Parse("Green");
        ...
        btn7x5.BackgroundColor = Color.Parse("Green"); btn7x5.BorderColor = Color.Parse("Green");
        ...
        btn7x6.BackgroundColor = Color.Parse("Green"); btn7x6.BorderColor = Color.Parse("Green");
        ...
        btn7x7.BackgroundColor = Color.Parse("Green"); btn7x7.BorderColor = Color.Parse("Green");
        btn1x8.BackgroundColor = Color.Parse("Green"); btn1x8.BorderColor = Color.Parse("Green");
        btn2x8.BackgroundColor = Color.Parse("Green"); btn2x8.BorderColor = Color.Parse("Green");
        btn3x8.BackgroundColor = Color.Parse("Green"); btn3x8.BorderColor = Color.Parse("Green");
        btn4x8.BackgroundColor = Color.Parse("Green"); btn4x8.BorderColor = Color.Parse("Green");
        btn5x8.BackgroundColor = Color.Parse("Green"); btn5x8.BorderColor = Color.Parse("Green");
        btn6x8.BackgroundColor = Color.Parse("Green"); btn6x8.BorderColor = Color.Parse("Green");
        btn7x8.BackgroundColor = Color.Parse("Green"); btn7x8.BorderColor = Color.Parse("Green");
    }
    public void GameOver()
    {
        ...
        btn7x7.IsVisible = false;
        btn1x8.IsVisible = false;
        btn2x8.IsVisible = false;
        btn3x8.IsVisible = false;
        btn4x8.IsVisible = false;
        btn5x8.IsVisible = false;
        btn6x8.IsVisible = false;
        btn7x8.IsVisible = false;
    ...
    public void ShowCorrectButtonCol7()
    {
        ...
        switch (correctIndex)
        {
            ...
            case 5:
                ...
                break;
            case 6:
                btn7x7.BackgroundColor = Color.Parse("#FFD700");
                break;
            default:
                break;
        }
    }
    public void ShowCorrectButtonCol8()
    {
        int correctIndex = 0;

        for (int i = 0; i < Constants.NUM_ROWS; i++)
        {
            if (_columnArray8[i] == 1)
            {
                correctIndex = i;
                break;
            }
        ...
        {
            case 0:
                btn1x8.BackgroundColor = Color.Parse("#FFD700");
                break;
            case 1:
                btn2x8.BackgroundColor = Color.Parse("#FFD700");
                break;
            case 2:
                btn3x8.BackgroundColor = Color.Parse("#FFD700");
                break;
            case 3:
                btn4x8.BackgroundColor = Color.Parse("#FFD700");
                break;
            case 4:
                btn5x8.BackgroundColor = Color.Parse("#FFD700");
                break;
            case 5:
                btn6x8.BackgroundColor = Color.Parse("#FFD700");
                break;
            case 6:
                btn7x8.BackgroundColor = Color.Parse("#FFD700");
                break;
            default:
                break;
        }
    ...
    public void DisableColumn1()
    {
        ...
        btn7x1.IsEnabled = false; btn7x1.BorderColor = Color.Parse("#3B3B3B");
    ...
    public void DisableColumn2()
    {
        ...
        btn7x2.IsEnabled = false; btn7x2.BorderColor = Color.Parse("#3B3B3B");
    ...
    public void DisableColumn3()
    {
        ...
        btn7x3.IsEnabled = false; btn7x3.BorderColor = Color.Parse("#3B3B3B");
    ...
    public void DisableColumn4()
    {
        ...
        btn7x4.IsEnabled = false; btn7x4.BorderColor = Color.Parse("#3B3B3B");
    ...
    public void DisableColumn5()
    {
        ...
        btn7x5.IsEnabled = false; btn7x5.BorderColor = Color.Parse("#3B3B3B");
    ...
    public void DisableColumn6()
    {
        ...
        btn7x6.IsEnabled = false; btn7x6.BorderColor = Color.Parse("#3B3B3B");
    ...
    public void DisableColumn7()
    {
        ...
        btn7x7.IsEnabled = false; btn7x7.BorderColor = Color.Parse("#3B3B3B");
        _disabledColumns[6] = true;
    }
    public void DisableColumn8()
    {
        btn1x8.IsEnabled = false; btn1x8.BorderColor = Color.Parse("#3B3B3B");
        btn2x8.IsEnabled = false; btn2x8.BorderColor = Color.Parse("#3B3B3B");
        btn3x8.IsEnabled = false; btn3x8.BorderColor = Color.Parse("#3B3B3B");
        btn4x8.IsEnabled = false; btn4x8.BorderColor = Color.Parse("#3B3B3B");
        btn5x8.IsEnabled = false; btn5x8.BorderColor = Color.Parse("#3B3B3B");
        btn6x8.IsEnabled = false; btn6x8.BorderColor = Color.Parse("#3B3B3B");
        btn7x8.IsEnabled = false; btn7x8.BorderColor = Color.Parse("#3B3B3B");
        _disabledColumns[7] = true;
    }
    public void EnableAllColumns()
    {
        ...
        btn7x1.IsEnabled = true; btn7x1.BorderColor = Color.Parse("White");
        ...
        btn7x2.IsEnabled = true; btn7x2.BorderColor = Color.Parse("White");
        ...
        btn7x3.IsEnabled = true; btn7x3.BorderColor = Color.Parse("White");
        ...
        btn7x4.IsEnabled = true; btn7x4.BorderColor = Color.Parse("White");
        ...
        btn7x5.IsEnabled = true; btn7x5.BorderColor = Color.Parse("White");
        ...
        btn7x6.IsEnabled = true; btn7x6.BorderColor = Color.Parse("White");
        ...
        btn7x7.IsEnabled = true; btn7x7.BorderColor = Color.Parse("White");
        btn1x8.IsEnabled = true; btn1x8.BorderColor = Color.Parse("White");
        btn2x8.IsEnabled = true; btn2x8.BorderColor = Color.Parse("White");
        btn3x8.IsEnabled = true; btn3x8.BorderColor = Color.Parse("White");
        btn4x8.IsEnabled = true; btn4x8.BorderColor = Color.Parse("White");
        btn5x8.IsEnabled = true; btn5x8.BorderColor = Color.Parse("White");
        btn6x8.IsEnabled = true; btn6x8.BorderColor = Color.Parse("White");
        btn7x8.IsEnabled = true; btn7x8.BorderColor = Color.Parse("White");
    }
    ...
    public void DisableAllColumns()
    {
        ...
        btn4x1.IsEnabled = false; btn4x1.BorderColor = Color.Parse("#3B3B3B");
        btn5x1.IsEnabled = false; btn5x1.BorderColor = Color.Parse("#3B3B3B");
        btn6x1.IsEnabled = false; btn7x1.BorderColor = Color.Parse("#3B3B3B");
        btn7x1.IsEnabled = false; btn6x1.BorderColor = Color.Parse("#3B3B3B");
        btn1x2.IsEnabled = false; btn1x2.BorderColor = Color.Parse("#3B3B3B");
        btn2x2.IsEnabled = false; btn2x2.BorderColor = Color.Parse("#3B3B3B");
        btn3x2.IsEnabled = false; btn3x2.BorderColor = Color.Parse("#3B3B3B");
        btn4x2.IsEnabled = false; btn4x2.BorderColor = Color.Parse("#3B3B3B");
    ...
    // These ButtonClicked events will assign a value between 1 and 7 to an array (_chosenIndexes) that stores the indexes of the
    ...
    public void Btn7x7Clicked(object sender, EventArgs e)
    {
        _chosenIndexes[6] = 7;
        btn7x7.BackgroundColor = Color.Parse("#FFD700");
        DisableColumn7();
    ...
    // Column 8
    public void Btn1x8Clicked(object sender, EventArgs e)
    {
        _chosenIndexes[7] = 1;
        btn1x8.BackgroundColor = Color.Parse("#FFD700");
        DisableColumn8();
    ...
    public void Btn2x8Clicked(object sender, EventArgs e)
    {
        _chosenIndexes[7] = 2;
        btn2x8.BackgroundColor = Color.Parse("#FFD700");
        DisableColumn8();
    ...
    public void Btn3x8Clicked(object sender, EventArgs e)
    {
        _chosenIndexes[7] = 3;
        btn3x8.BackgroundColor = Color.Parse("#FFD700");
        DisableColumn8();
    ...
    public void Btn4x8Clicked(object sender, EventArgs e)
    {
        _chosenIndexes[7] = 4;
        btn4x8.BackgroundColor = Color.Parse("#FFD700");
        DisableColumn8();
    ...
    public void Btn5x8Clicked(object sender, EventArgs e)
    {
        _chosenIndexes[7] = 5;
        btn5x8.BackgroundColor = Color.Parse("#FFD700");
        DisableColumn8();
    ...
    public void Btn6x8Clicked(object sender, EventArgs e)
    {
        _chosenIndexes[6] = 6;
        btn6x8.BackgroundColor = Color.Parse("#FFD700");
        DisableColumn8();
    ...
    public void Btn7x8Clicked(object sender, EventArgs e)
    {
        _chosenIndexes[7] = 7;
        btn7x8.BackgroundColor = Color.Parse("#FFD700");
        DisableColumn8();
    ...
    public async void ReturnToMainMenu(object sender, EventArgs e)
    {
        ...
        _save.SaveImpossiblePlayerData();
